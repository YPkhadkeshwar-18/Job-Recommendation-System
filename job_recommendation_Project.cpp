...
void solve()
{
    ...
    job["Dancer"] = {{15, "Team_work"}, {25, "Boldness"}, {35, "Enthausiastic"}, {45, "Flexible"}};
    job["Beautician"] = {{15, ""}, {25, "Love_your_job"}, {35, "Can work overtime if pays well"}, {45, "Something_creative"}};
    job["Actor"] = {{15, "Both_passion_and_money"}, {25, "Artistic"}, {35, "Communication_skill"}, {45, "Boldness"}};
    job["Manager"] = {{15, "Smart_work"}, {25, "Striclty_professional"}, {35, "Good_communication"}, {45, "Dealing_with_people"}};
    job["Architect"] = {{15, "Problem_solving_ability"}, {25, "Innovative"}, {35, "Analytical_thinking"}, {45, "Perfect_planner"}};
    job["Astronaut"] = {{15, "Analytical_thinking"}, {25, "Research_skill"}, {35, "Adapting_surrounding"}, {45, "Study"}}; 
    job["Sportsman"] = {{15, "Team_work"}, {25, "Hard_work"}, {35, "Leadership"}, {45, "Enthausiastic"}};
    job["Judge"] = {{15, "9 to 5 job"}, {25, "Problem_solving_ability"}, {35, "Calm"}, {45, "Decision_making_skills"}};
    job["Businessman"] = {{15, "Hard_work"}, {25, "Problem_solving_ability"}, {35, "Dealing_with_people"}, {45, "To_achieve_big_success"}};
    job["Chartered_accountant"] = {{15, "Analytical_thinking"}, {25, ""}, {35, "Problem_solving_ability"}, {45, "Study"}};
    int n; cin >> n;
    string skill[n];
